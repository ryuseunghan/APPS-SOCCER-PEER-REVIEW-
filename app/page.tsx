...
export default function LandingPage() {
  return (
    <div className="min-h-screen flex flex-col items-center justify-between bg-[#0D1B3E] px-6 py-16 max-w-lg mx-auto">
      {/* Hero */}
      <div className="flex-1 flex flex-col items-center justify-center text-center gap-8">
        {/* Club Logo + Service Brand */}
        ...
        <p className="text-[#7B9DD4] text-sm leading-relaxed max-w-xs">
      ...
      <div className="w-full space-y-4">
        ...
        <div className="text-center">
          ...
          <Link
            href="/home"
            className="text-[#22C55E] text-sm font-medium underline underline-offset-2"
          >
            로그인
          </Link>
        </div>
